...
typedef NS_ENUM(NSInteger, ImageCompressionType) {
    imageCompressionTypeOriginal = 0,
    imageCompressionTypeSmall = 1,
    imageCompressionTypeMedium = 2,
 ...
 *
 *  @return array of compressed url
 */
...
// set image with cross dissolve animation
